...
#define BOOST_UNORDERED_EMPLACE(z, n, _)                                       \
    ...
    BOOST_PP_REPEAT_FROM_TO(
        10, BOOST_UNORDERED_EMPLACE_LIMIT, BOOST_UNORDERED_EMPLACE, _)
...
#undef BOOST_UNORDERED_EMPLACE
  ...
  public:
    ...
    // Define the no argument try_emplace this way to make it a template.
    // Also handles the key_type&& overload.
    // TODO: Is it really necessary to it this way?
    ...
    // 0 argument overload already handled.
    ...
    {
        return table_.try_emplace_unique(
            boost::move(k), boost::forward<A0>(a0));
    }
...
unordered_map<K, T, H, P, A>::unordered_map(unordered_map const& other)
    : table_(other.table_,
          table::node_allocator_traits::select_on_container_copy_construction(
                 other.table_.node_alloc()))
{
