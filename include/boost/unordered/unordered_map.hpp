...
namespace unordered
{
    ...
    public:
        ...
        {
            return table_.try_emplace_(boost::forward<Key>(k));
        }

        template <typename Key>
        iterator try_emplace(const_iterator hint, BOOST_FWD_REF(Key) k)
        {
            return table_.try_emplace_hint_(hint, boost::forward<Key>(k));
        }
        ...
        iterator try_emplace(const_iterator hint, key_type const& k,
            BOOST_FWD_REF(A0) a0)
        {
            return table_.try_emplace_hint_(hint, k,
                boost::unordered::detail::create_emplace_args(
                    boost::forward<A0>(a0))
            );
        }
        ...
        std::pair<iterator, bool> try_emplace(BOOST_RV_REF(key_type) k,
            BOOST_FWD_REF(A0) a0)
        {
            return table_.try_emplace_(boost::move(k), boost::forward<A0>(a0));
        }
        ...
        iterator try_emplace(const_iterator hint, BOOST_RV_REF(key_type) k,
            BOOST_FWD_REF(A0) a0)
        {
            return table_.try_emplace_hint_(hint, boost::move(k), boost::forward<A0>(a0));
        }
        ...
        std::pair<iterator, bool> try_emplace(BOOST_RV_REF(key_type) k,
            ...
            BOOST_FWD_REF(A1) a1)
        {
            return table_.try_emplace_(boost::move(k),
                boost::unordered::detail::create_emplace_args(
                    boost::forward<A0>(a0),
                    boost::forward<A1>(a1)));
        }
        ...
        iterator try_emplace(const_iterator hint, BOOST_RV_REF(key_type) k,
            ...
            BOOST_FWD_REF(A1) a1)
        {
            return table_.try_emplace_hint_(hint, boost::move(k),
                boost::unordered::detail::create_emplace_args(
                    boost::forward<A0>(a0),
                    boost::forward<A1>(a1)));
        }
        ...
        iterator try_emplace(const_iterator hint, key_type const& k,
            ...
            BOOST_FWD_REF(A2) a2)
        {
            return table_.try_emplace_impl_(hint, k,
                boost::unordered::detail::create_emplace_args(
                    boost::forward<A0>(a0),
                    boost::forward<A1>(a1),
...
#undef BOOST_UNORDERED_EMPLACE
        ...
        {
            return table_.insert_or_assign_(k, boost::forward<M>(obj));
        }

        template <class M>
        iterator insert_or_assign(const_iterator, key_type const& k, BOOST_FWD_REF(M) obj)
        {
            return table_.insert_or_assign_(k, boost::forward<M>(obj)).first;
        }

        template <class M>
        std::pair<iterator, bool> insert_or_assign(BOOST_RV_REF(key_type) k, BOOST_FWD_REF(M) obj)
        {
            return table_.insert_or_assign_(boost::move(k), boost::forward<M>(obj));
        }

        template <class M>
        iterator insert_or_assign(const_iterator, BOOST_RV_REF(key_type) k, BOOST_FWD_REF(M) obj)
        {
            return table_.insert_or_assign_(boost::move(k), boost::forward<M>(obj)).first;
        }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    {
        return table_.try_emplace_(k).first->second;
    }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    template <class K, class T, class H, class P, class A>
    template <typename H2, typename P2>
    void unordered_multimap<K,T,H,P,A>::merge(boost::unordered_multimap<K,T,H2,P2,A>& source)
    {
        while (!source.empty()) {
