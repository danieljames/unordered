...
namespace unordered
{
    ...
    private:
        ...
        typedef boost::unordered::detail::set_base<T, H, P, A> types;
...
#undef BOOST_UNORDERED_EMPLACE
    ...
    private:
        ...
        typedef boost::unordered::detail::multiset_base<T, H, P, A> types;
        typedef typename types::base table;
        typedef typename table::value_allocator_traits value_allocator_traits;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    template <class T, class H, class P, class A>
    template <typename H2, typename P2>
    void unordered_set<T,H,P,A>::merge(boost::unordered_multiset<T,H2,P2,A>& source)
    {
        this->merge_impl(source);
    }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    template <class T, class H, class P, class A>
    template <typename H2, typename P2>
    void unordered_multiset<T,H,P,A>::merge(boost::unordered_set<T,H2,P2,A>& source)
    {
        while (!source.empty()) {
            insert(source.extract(source.begin()));
        }
