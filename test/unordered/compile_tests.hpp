...
void unordered_set_test(X& r, Key const&)
{
    typedef BOOST_DEDUCED_TYPENAME X::value_type value_type;
...
void unordered_unique_test(X& r, T const& t)
{
    ...
    //TODO; boost::function_requires<boost::MoveConstructibleConcept<insert_return_type> >();
    //TODO; boost::function_requires<boost::MoveAssignableConcept<insert_return_type> >();
    boost::function_requires<boost::DefaultConstructibleConcept<insert_return_type> >();
    //TODO: boost::function_requires<boost::DestructibleConcept<insert_return_type> >();
...
void unordered_map_functions(X&, Key const& k, T const& v)
{
    ...
    test::check_return_type<std::pair<iterator, bool> >::equals(a.try_emplace(k, v));
    test::check_return_type<std::pair<iterator, bool> >::equals(a.try_emplace(rvalue(k), v));
    test::check_return_type<iterator>::equals(a.try_emplace(a.begin(), k, v));
    test::check_return_type<iterator>::equals(a.try_emplace(a.begin(), rvalue(k), v));
    test::check_return_type<std::pair<iterator, bool> >::equals(a.insert_or_assign(k, v));
    test::check_return_type<std::pair<iterator, bool> >::equals(a.insert_or_assign(rvalue(k), v));
    test::check_return_type<iterator>::equals(a.insert_or_assign(a.begin(), k, v));
    test::check_return_type<iterator>::equals(a.insert_or_assign(a.begin(), rvalue(k), v));
