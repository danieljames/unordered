...
template <class X>
void merge_empty_test(X*, test::random_generator generator)
{
...
template <class X>
void unique_merge_test(X*, test::random_generator generator)
{
    test::check_instances check_;
    ...
    for(BOOST_DEDUCED_TYPENAME test::ordered<X>::iterator
            it = tracker_tmp.begin(); it != tracker_tmp.end(); ++it)
    {
...
template <class X>
void equiv_merge_test(X*, test::random_generator generator)
{
    test::check_instances check_;
...
UNORDERED_TEST(merge_empty_test,
    (
     (test_set_std_alloc)(test_multimap_std_alloc)
...
UNORDERED_TEST(equiv_merge_test,
    (
